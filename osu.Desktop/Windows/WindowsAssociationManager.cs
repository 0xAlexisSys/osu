...
namespace osu.Desktop.Windows
{
    ...
    public static partial class WindowsAssociationManager
    {
        ...
        private static readonly ApplicationCapability application_capability = new ApplicationCapability(@"osu-sp", @"Software\ppy\osu-sp\Capabilities", "osu-sp");
        ...
        public static void InstallAssociations()
        {
            ...
            {
                Logger.Error(e, $@"Failed to install file associations: {e.Message}");
            }
        }
        ...
        public static void UpdateAssociations()
        {
            ...
            {
                Logger.Error(e, @"Failed to update file associations.");
            }
        }
        ...
        public static void LocaliseDescriptions(LocalisationManager localisationManager)
        {
            ...
            {
                Logger.Error(e, @"Failed to update file association descriptions.");
            }
        }
        ...
        public static void UninstallAssociations()
        {
            ...
            {
                Logger.Error(e, @"Failed to uninstall file associations.");
            }
        }
