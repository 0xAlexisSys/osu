    ...
    public partial class TestSceneBeatmapDifficultyCache : OsuTestScene
    {
        ...
        public void TestStarDifficultyChangesOnModSettings()
        {
            ...
            AddStep("set computation function", () => difficultyCache.ComputeDifficulty = lookup =>
            {
                ...
                return new StarDifficulty(BASE_STARS + modRateAdjust?.SpeedChange.Value ?? 0);
            });
        ...
        public void TestStarDifficultyAdjustHashCodeConflict()
        {
            ...
            AddStep("set computation function", () => difficultyCache.ComputeDifficulty = lookup =>
            {
                ...
                return new StarDifficulty(BASE_STARS * (modDifficultyAdjust?.OverallDifficulty.Value ?? 1));
            });
        ...
        {
            var key1 = new BeatmapDifficultyCache.DifficultyCacheLookup(new BeatmapInfo { ID = guid }, new RulesetInfo { ID = 0 }, new Mod[] { new OsuModHardRock(), new OsuModHidden() });
            var key2 = new BeatmapDifficultyCache.DifficultyCacheLookup(new BeatmapInfo { ID = guid }, new RulesetInfo { ID = 0 }, new Mod[] { new OsuModHardRock(), new OsuModHidden() });
        ...
        {
            var key1 = new BeatmapDifficultyCache.DifficultyCacheLookup(new BeatmapInfo { ID = guid }, new RulesetInfo { ID = 0 }, new Mod[] { new OsuModHardRock(), new OsuModHidden() });
            var key2 = new BeatmapDifficultyCache.DifficultyCacheLookup(new BeatmapInfo { ID = guid }, new RulesetInfo { ID = 0 }, new Mod[] { new OsuModHidden(), new OsuModHardRock() });
        ...
        {
            var key1 = new BeatmapDifficultyCache.DifficultyCacheLookup(new BeatmapInfo { ID = guid }, new RulesetInfo { ID = 0 },
                new Mod[] { new OsuModDoubleTime { SpeedChange = { Value = 1.1 } } });
            var key2 = new BeatmapDifficultyCache.DifficultyCacheLookup(new BeatmapInfo { ID = guid }, new RulesetInfo { ID = 0 },
        ...
        private partial class TestBeatmapDifficultyCache : BeatmapDifficultyCache
        {
            ...
            {
                return Task.FromResult<StarDifficulty?>(ComputeDifficulty?.Invoke(lookup) ?? new StarDifficulty(BASE_STARS));
            }
        }
    }
}
