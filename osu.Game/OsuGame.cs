    ...
    public partial class OsuGame : OsuGameBase, IKeyBindingHandler<GlobalAction>, ILocalUserPlayInfo, IPerformFromScreenRunner, IOverlayManager
    {
            ...
            PerformFromScreen(screen =>
            {
                ...
                switch (presentType)
                {
                    ...
                    case ScorePresentType.Results:
                        screen.Push(new ResultsScreen(databasedScore.ScoreInfo));
                        break;
                }
        ...
        private void updateWindowTitle()
        {
            ...
            switch (configUserActivity.Value)
            {
                ...
                case UserActivity.PlayingBeatmap:
        ...
        protected override void LoadComplete()
        {
            ...
            loadComponentSingleFile<NotificationOverlay>(Notifications.With(d =>
            {
