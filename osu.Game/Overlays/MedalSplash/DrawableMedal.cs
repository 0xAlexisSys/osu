...
namespace osu.Game.Overlays.MedalSplash
{
    ...
    public partial class DrawableMedal : Container, IStateful<DisplayState>
    {
        ...
        private readonly SpriteTextWithTooltip name;
        ...
        public DrawableMedal(Medal medal)
        {
            ...
            Children = new Drawable[]
            {
                ...
                infoFlow = new FillFlowContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        name = new SpriteTextWithTooltip
                        {
                            Anchor = Anchor.TopCentre,
                            Origin = Anchor.TopCentre,
                            Text = medal.Title,
        ...
        {
            medalSprite.Texture = largeTextures.Get(medal.Icon) ?? largeTextures.Get(@"Medals/unknown");
        ...
        private void updateState()
        {
            ...
            switch (state)
            {
                ...
                case DisplayState.Full:
                    ...
                    unlocked.Show();
                    if (medal.TooltipText is not null)
                        name.TooltipText = medal.TooltipText;
