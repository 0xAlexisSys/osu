...
namespace osu.Game.Rulesets.Judgements
{
    ...
    public class JudgementResult
    {
        ...
        {
            get => RawTime is not null ? Math.Min(RawTime.Value - HitObject.GetEndTime(), HitObject.MaximumJudgementOffset) : 0;
        ...
        /// </remarks>
        public double TimeAbsolute => RawTime is not null ? Math.Min(RawTime.Value, HitObject.GetEndTime() + HitObject.MaximumJudgementOffset) : HitObject.GetEndTime();
