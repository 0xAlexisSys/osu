...
namespace osu.Game.Utils
{
    ...
    public static class ModUtils
    {
        ...
        public static bool InstantiateValidModsForRuleset(Ruleset ruleset, IEnumerable<JsonMod> proposedMods, out List<Mod> valid)
        {
            valid = new List<Mod>();
            bool proposedWereValid = true;

            foreach (var jsonMod in proposedMods)
            {
                var mod = jsonMod.ToMod(ruleset);
        ...
        public static Mod[] EnumerateUserSelectableFreeMods(IEnumerable<JsonMod> requiredMods, IEnumerable<JsonMod> allowedMods, bool freestyle, Ruleset userRuleset)
        {
            if (freestyle)
            {
